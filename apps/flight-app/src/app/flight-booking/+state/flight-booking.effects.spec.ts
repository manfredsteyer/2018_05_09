...
import { LoadFlightBooking, FlightsLoadedAction } from './flight-booking.actions';
...
describe('FlightBookingEffects', () => {
  ...
  describe('someEffect', () => {
    it('should work', () => {
      ...
      expect(effects$.loadFlightBooking$).toBeObservable(hot('-a-|', { a: new FlightsLoadedAction({}) }));
    });
  });
});
